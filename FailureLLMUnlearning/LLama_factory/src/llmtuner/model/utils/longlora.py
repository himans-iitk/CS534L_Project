...
# Try to import optional attention classes - may not exist in newer transformers versions
try:
    from transformers.models.llama.modeling_llama import LlamaFlashAttention2
except ImportError:
    # In newer transformers versions, FlashAttention2 might be handled differently
    LlamaFlashAttention2 = None

try:
    from transformers.models.llama.modeling_llama import LlamaSdpaAttention
except ImportError:
    # In newer transformers versions, SDPA attention might be handled differently
...
def _apply_llama_patch() -> None:
    # Note: transformers version check relaxed to support newer versions
